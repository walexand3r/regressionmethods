%% Testing Stochastic Smoothed Gradient Descent regression on Boston Housing Data
...
% %Previous section takes long time fowr my computer therefore optimal lambda
% %is printed here:
% optlambda = 0.04;
