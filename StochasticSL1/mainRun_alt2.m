...
% Further lambda experimentation
% runtime = zeros(1,100);
%  
% for p = 1:50
%    tic
...
for i = 1
    lambda(i) = i/10;
    w = stochastic_smoothed_11_regression_opt2(train_X,train_y,lambda(i));
...
w = stochastic_smoothed_11_regression_opt2(trainval_X,trainval_y,optlambda);
